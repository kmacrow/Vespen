...
/* Write/POST binary data. cb(result) is called with result = 0 
 * in case of error. Otherwise result = 1. data can be a string, 
 * Array or Uint8Array depending on the implementation. 
*/
function write_binary(url, data, cb) {
    
    var req, res;
    
    console.log('WRITE: ', url, data.length);
